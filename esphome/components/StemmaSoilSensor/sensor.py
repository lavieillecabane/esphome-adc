...
StemmaSoilSensor_ns = cg.esphome_ns.namespace("StemmaSoilSensor")

TSL2591IntegrationTime = StemmaSoilSensor_ns.enum("TSL2591IntegrationTime")
INTEGRATION_TIMES = {
...
TSL2591ComponentGain = StemmaSoilSensor_ns.enum("TSL2591ComponentGain")
GAINS = {
...
TSL2591Component = StemmaSoilSensor_ns.class_(
